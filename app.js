 ...
 * Blog routes
 */
app.get('/blog', passportConfig.isAuthenticated, blogController.getBlogs);
app.post('/blog', passportConfig.isAuthenticated, blogController.createBlog);
app.put('/blog/:blogId', passportConfig.isAuthenticated, blogController.updateBlog);
app.delete('/blog/:blogId', passportConfig.isAuthenticated, blogController.deleteBlog);
